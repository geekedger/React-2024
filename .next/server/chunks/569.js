      ...
      r.a(e, async (e, a) => {
        try {
          ...
          let v = ({
            ...
            let [f, k] = (0, o.useState)(null),
              [v, S] = (0, d.Z)("searchTerm", t),
              [b, j] = (0, d.Z)("page", (r || 1).toString());
            console.log(`Page from localStorage: ${b}`),
              console.log(`SearchTerm from localStorage: ${v}`);
            let P = (0, n.useRouter)(),
              C = (0, g.useDispatch)(),
              w = (0, g.useSelector)((e) => e.currentPage.page),
              Z = (0, g.useSelector)((e) => e.currentPage.items),
              N = isNaN(parseInt(b)) ? w : parseInt(b);
            console.log("Current Page Number to Dispatch:", N);
            let {
              data: D,
              error: E,
              isLoading: F,
            ...
            (0, o.useEffect)(() => {
              P.query.page && j(P.query.page),
                P.query.search && S(P.query.search);
            }, [P.query.page, P.query.search, j, S]),
              (0, o.useEffect)(() => {
                D?.results
            ...
            return (0, s.jsxs)("div", {
              ...
              children: [
                    ...
                    (0, s.jsxs)("div", {
                      ...
                      children: [
                        ...
                        f &&
                          !F &&
                          s.jsx("p", {
                            className: x()["error-message"],
                            children: f,
                          }),
                      ],
                    }),
                    s.jsx("div", {
                      className: x()["app-bottom"],
                      children:
                        !F &&
                        !f &&
                        (0, s.jsxs)(s.Fragment, {
                ...
                s.jsx("div", { className: x()["app-right"], children: a }),
              ],
            });
          };
          a();
      ...
      let i = ({ next: e }) => {
        ...
        return (0, a.jsxs)("div", {
          ...
          children: [
            ...
            (0, a.jsxs)("span", { children: ["Page ", o] }),
            e && a.jsx("button", { onClick: () => l(o + 1), children: "Next" }),
          ],
        });
      };
    },
